...
// @antifeature  payment
// @downloadURL https://update.sleazyfork.org/scripts/462265/%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.sleazyfork.org/scripts/462265/%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function ($$1) {
  ...
  const $container = $$1(
    ...
    <a class="crack_title crack_jump_link" target="_blank" style="color:red;" href="https://pomf2.lain.la/f/h98hgfvn.png">失业求打赏</a>
  </div>`
  );
  const initCrackDom = () => {
  ...
  const handleSuccessImg = () => {
    ...
    $container.children().first().next().after(successImg);
  };
  const videosSuccessHelperDom = (url) => {
    ...
    $container.append(jumpLink1).append(jumpLink2).append(jumpLink3).append(downloadLink).append(copyUrl);
  };
